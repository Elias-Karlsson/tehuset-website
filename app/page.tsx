...
export default function Home() {
  return <TehusetHome site={site as SiteContent} photos={photos} menuSv={menuSv as MenuContent} menuEn={menuEn as MenuContent} products={productsData.products as Product[]} />;
}
