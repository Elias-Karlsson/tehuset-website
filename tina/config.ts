    ...
    collections: [
      {
        ...
        fields: [
          ...
          { type: 'object', name: 'history', label: 'History archive', fields: [localizedText('Eyebrow', 'eyebrow'), localizedText('Title', 'title'), localizedText('Body', 'body', 'textarea'), { type: 'object', name: 'images', label: 'Archive images', list: true, fields: [{ type: 'image', name: 'src', label: 'Image' }, localizedText('Caption', 'caption'), { type: 'string', name: 'credit', label: 'Credit' }] }] },
        ],
      },
      {
        name: 'menus',
